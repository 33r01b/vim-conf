...
source $HOME/.vim/etc/plugins/completion/phpcd.vim
source $HOME/.vim/etc/plugins/completion/php-namespace.vim
source $HOME/.vim/etc/plugins/completion/pear-tree.vim
